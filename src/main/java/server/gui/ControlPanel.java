...
public class ControlPanel extends JFrame {
	...
	public void initComponents() {
		...
		MESSAGE_ALL_BOX.setModel(new DefaultComboBoxModel(
				new String[] { "[Alert]", "[Update]", "[Server]", "[Robgob]",
						"[Control Panel]", "[Panel]", "[Console]", "[Prompt]",
						"[None]" }));
		MESSAGE_ALL_BOX
				.setToolTipText("Choose a name that will show next to the message.");
		...
		if (PANEL_ACTIVE) {
			SYSTEM_OUT = new PrintStream(System.out) {
				...
				public void println(String x) {
					...
					CONSOL_SCROLLER.getVerticalScrollBar()
							.setValue(
									CONSOL_SCROLLER.getVerticalScrollBar()
											.getMaximum());
				}
		...
		IPMUTE_PLAYER
				.setToolTipText("IP-Mute a player so that any same connection cannot speak.");
		...
		PLAYER_CONTROLSLayout
				.setHorizontalGroup(PLAYER_CONTROLSLayout
		...
		PLAYER_CONTROLSLayout
				.setVerticalGroup(PLAYER_CONTROLSLayout
						.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addGroup(
								PLAYER_CONTROLSLayout
										.createSequentialGroup()
		...
		REMOVE_ITEM
				.setToolTipText("Remove an item from the players inventory.");
		...
		EMPTY_INVENTORY
				.setToolTipText("Delete ALL items in the players Inventory.");
		...
		UNEQUIP_ITEM
				.setToolTipText("Force the player to remove an item from their equipment slot.");
		...
		REMOVE_OBTAINED_ITEMS
				.setToolTipText("Warning! This will delete ALL of the players items!!!!");
		REMOVE_OBTAINED_ITEMS
		...
		PLAYER_EQUIPMENTLayout
				.setHorizontalGroup(PLAYER_EQUIPMENTLayout
						.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addGroup(
								PLAYER_EQUIPMENTLayout
										.createSequentialGroup()
										...
										.addContainerGap()));
		PLAYER_EQUIPMENTLayout
				.setVerticalGroup(PLAYER_EQUIPMENTLayout
						.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addGroup(
								PLAYER_EQUIPMENTLayout
										.createSequentialGroup()
										...
										.addPreferredGap(
												...
												GroupLayout.DEFAULT_SIZE,
												Short.MAX_VALUE)
										.addComponent(REMOVE_OBTAINED_ITEMS,
												GroupLayout.PREFERRED_SIZE, 35,
												GroupLayout.PREFERRED_SIZE)
										.addContainerGap()));
		...
		FORCE_COMMANDS.setBorder(BorderFactory
		...
		FORCE_COMMANDS.setModel(new AbstractListModel() {
			String[] strings = { "Force Animation", "Display GFX", "Lock EXP",
					"Force Bank", "Force Shop", "Force Death", "Force Command",
					"Force Chat", "Give Master", "Add SkillXP",
					"Remove SkillXP", "Reset Skill", "Reset All Skills" };
		...
		FORCE_COMMANDS
				.setToolTipText("Another list of commands you can force the player to perfoem.");
		...
		PLAYER_MISCLayout
				.setHorizontalGroup(PLAYER_MISCLayout
						.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addGroup(
								GroupLayout.Alignment.TRAILING,
								PLAYER_MISCLayout
										...
										.addContainerGap()));
		PLAYER_MISCLayout
				.setVerticalGroup(PLAYER_MISCLayout
						.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addGroup(
								PLAYER_MISCLayout
										.createSequentialGroup()
		...
		TELEPORT_LIST.setBorder(BorderFactory
				.createLineBorder(new java.awt.Color(0, 0, 0)));
		...
		PLAYER_LOCATIONLayout
				.setHorizontalGroup(PLAYER_LOCATIONLayout
						.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addGroup(
								PLAYER_LOCATIONLayout
										.createSequentialGroup()
										...
										.addGroup(
												PLAYER_LOCATIONLayout
														...
														.addComponent(
																...
																Short.MAX_VALUE))
										.addContainerGap()));
		PLAYER_LOCATIONLayout.setVerticalGroup(PLAYER_LOCATIONLayout
		...
		UPDATE_PLAYERS
				.setToolTipText("Update the players to their origional look.");
		...
		PLAYER_PANELLayout
				.setHorizontalGroup(PLAYER_PANELLayout
						.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addGroup(
								PLAYER_PANELLayout
										.createSequentialGroup()
										...
										.addGroup(
												PLAYER_PANELLayout
														...
														.addComponent(
																...
																Short.MAX_VALUE))
										.addGap(24, 24, 24)));
		PLAYER_PANELLayout.setVerticalGroup(PLAYER_PANELLayout
				.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(
						PLAYER_PANELLayout
								.createSequentialGroup()
								.addContainerGap()
								.addComponent(MAKE_NPC,
										GroupLayout.PREFERRED_SIZE, 34,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(
										LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(UPDATE_PLAYERS,
										GroupLayout.PREFERRED_SIZE, 34,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(
										LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(TELE_ALL,
										GroupLayout.PREFERRED_SIZE, 34,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(
										LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(KICK_ALL,
										GroupLayout.PREFERRED_SIZE, 34,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(
										LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(FORCE_CHAT,
										GroupLayout.PREFERRED_SIZE, 34,
										GroupLayout.PREFERRED_SIZE)
								.addGap(47, 47, 47))
				.addGroup(
						PLAYER_PANELLayout.createSequentialGroup()
								.addComponent(PLAYER_CONTROLS_TAB)
								.addGap(22, 22, 22)));
		...
		FORCE_NPCS_CHAT_TEXT
				.setToolTipText("Enter a line of text you wish to have all npcs in game to say.");
		...
		NPC_OPTION_LIST.setBorder(BorderFactory
				.createLineBorder(new java.awt.Color(102, 0, 102)));
		NPC_OPTION_LIST.setForeground(new java.awt.Color(153, 0, 153));
		NPC_OPTION_LIST
				.setToolTipText("A list of Npc ID's to use for the following settings.");
		...
		NPCS_PANELLayout
				.setHorizontalGroup(NPCS_PANELLayout
						.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addGroup(
								GroupLayout.Alignment.TRAILING,
								NPCS_PANELLayout
										...
										.addContainerGap()));
		NPCS_PANELLayout
				.setVerticalGroup(NPCS_PANELLayout
						.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addGroup(
								NPCS_PANELLayout
										.createSequentialGroup()
		...
		ADMINS_CAN_TRADE
				.setToolTipText("Determins wether or not an admin can trade other players.");
		...
		javax.swing.GroupLayout SETTINGS_PANELLayout = new javax.swing.GroupLayout(
				SETTINGS_PANEL);
		SETTINGS_PANEL.setLayout(SETTINGS_PANELLayout);
		SETTINGS_PANELLayout
				.setHorizontalGroup(SETTINGS_PANELLayout
						.createParallelGroup(
						...
						.addGroup(
								SETTINGS_PANELLayout
										...
										.addContainerGap()));
		SETTINGS_PANELLayout
				.setVerticalGroup(SETTINGS_PANELLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								SETTINGS_PANELLayout
		...
		MESSAGE_ALL_BUTTON
				.setToolTipText("Send a message to everyone on the server");
		MESSAGE_ALL_BUTTON
				.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		MESSAGE_ALL_BOX.setEditable(true);
		MESSAGE_ALL_BOX.setModel(new javax.swing.DefaultComboBoxModel(
				new String[] { "[Alert]", "[Update]", "[Server]", "[Robgob]",
						"[Control Panel]", "[Panel]", "[Console]", "[Prompt]",
						"[None]" }));
		MESSAGE_ALL_BOX
		...
		javax.swing.GroupLayout SERVER_CONTROLSLayout = new javax.swing.GroupLayout(
				SERVER_CONTROLS);
		SERVER_CONTROLS.setLayout(SERVER_CONTROLSLayout);
		SERVER_CONTROLSLayout
				.setHorizontalGroup(SERVER_CONTROLSLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								SERVER_CONTROLSLayout
						...
						.addGroup(
								SERVER_CONTROLSLayout
										...
										.addGap(203, 203, 203)));
		SERVER_CONTROLSLayout
				.setVerticalGroup(SERVER_CONTROLSLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								SERVER_CONTROLSLayout
		...
		SERVER_PANELLayout.setHorizontalGroup(SERVER_PANELLayout
				.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(
						SERVER_PANELLayout
								.createSequentialGroup()
								.addComponent(SERVER_SETTINGS,
										GroupLayout.PREFERRED_SIZE, 412,
										GroupLayout.PREFERRED_SIZE)
								.addContainerGap(GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)));
		SERVER_PANELLayout.setVerticalGroup(SERVER_PANELLayout
				.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addComponent(SERVER_SETTINGS, GroupLayout.Alignment.TRAILING,
						GroupLayout.DEFAULT_SIZE, 246, Short.MAX_VALUE));
		...
		GroupLayout SERVER_CONSOLE_TABLayout = new GroupLayout(
				SERVER_CONSOLE_TAB);
		SERVER_CONSOLE_TAB.setLayout(SERVER_CONSOLE_TABLayout);
		SERVER_CONSOLE_TABLayout.setHorizontalGroup(SERVER_CONSOLE_TABLayout
				.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addComponent(jScrollPane4, GroupLayout.DEFAULT_SIZE, 409,
						Short.MAX_VALUE));
		SERVER_CONSOLE_TABLayout.setVerticalGroup(SERVER_CONSOLE_TABLayout
				.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addComponent(jScrollPane4, GroupLayout.DEFAULT_SIZE, 246,
						Short.MAX_VALUE));

		CONTROL_TABS.addTab("Console", SERVER_CONSOLE_TAB);

		ENTITY_LIST.setBorder(BorderFactory
				.createLineBorder(new java.awt.Color(0, 0, 0)));
		...
		layout.setHorizontalGroup(layout.createParallelGroup(
				...
				layout.createSequentialGroup()
						.addContainerGap()
						.addComponent(SCROLL_PANE, GroupLayout.DEFAULT_SIZE,
								153, Short.MAX_VALUE)
						.addPreferredGap(
								LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(CONTROL_TABS, GroupLayout.PREFERRED_SIZE,
	...
	public final String[] MESSAGE_COLOR = { "Red", "Blue", "Green", "Yellow",
			"Magenta", "Orange", "Dark Red", "Dark Blue", "None" };

	public final String[] PANEL_TELEPORTS = { "Cutsom Location", "Edgevill",
			"Lumbridge", "Al-kharid", "Varrock", "Falador", "Camelot",
			"Ardounge", "Watchtower", "Trollheim", "Ape Atoll", "Canifas",
			"Port Sarim", "Rimmington", "Draynor", "IceQueen Lair",
			"Brimhaven Dungeon", "Gnome Agility", "Wilderness Agility",
			"Distant kingdom", "Maze Event", "Drill Instructor",
			"Grave Digger", "Karamja Lessers", "Evil Bob's Island",
			"Secret Island", "Ibans Trap", "Fishing Docks", "Mage Trainging",
			"Quest Place", "Duel Arena", "Bandit Camp", "Uzer" };
