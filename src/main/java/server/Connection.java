...
public class Connection {
	...
	private static final String MACFile = "./Data/bans/MACsBanned.txt";
	/**
	...
	private static boolean deleteFromFile(String file, String name) {
		try {
	...
	private static boolean addDataToFile(String fileName, String dataToAdd) {
		try {
