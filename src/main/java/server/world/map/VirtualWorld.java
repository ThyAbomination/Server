...
public class VirtualWorld {
	...
	public static final boolean I(int height, int currentX, int currentY,
		...
		if (currentX != futureX && futureY != currentY) {
			return server.world.map.I.I(height, currentX, currentY, currentX,
					futureY, a)
					&& server.world.map.I.I(height, currentX, currentY,
							futureX, currentY, a)
					&& server.world.map.I.I(height, currentX, currentY,
							futureX, futureY, a);
		}
		return server.world.map.I.I(height, currentX, currentY, futureX,
				futureY, a);
	}
