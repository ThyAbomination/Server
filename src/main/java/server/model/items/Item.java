...
public class Item {
	...
	public static boolean playerCape(int itemId) {
		String[] data = { "cloak", "Cape", "cape", "Ava's", "TokHaar" };
	...
	public static boolean playerBoots(int itemId) {
		String[] data = { "Shoes", "shoes", "boots", "Boots", "Flippers", "Steadfast", "Glaiven", "Ragefire" };
		String item = getItemName(itemId);
		if (item == null) {
			return false;
		}
	...
	public static boolean playerShield(int itemId) {
		String[] data = { "kiteshield", "book", "Book", "Kiteshield", "shield",
				"Shield", "Kite", "kite", "defender", "xil", "ward" };
		String item = getItemName(itemId);
		if (item == null) {
			return false;
		}
	...
	public static boolean playerAmulet(int itemId) {
		String[] data = { "amulet", "Amulet", "necklace", "Necklace",
				"Pendant", "pendant", "Symbol", "symbol", "stole", "scarf",
				"charm" };
		String item = getItemName(itemId);
		if (item == null) {
			return false;
	...
	public static boolean playerHats(int itemId) {
		String[] data = { "boater", "cowl", "peg", "helm", "coif", "mask",
				"hat", "headband", "hood", "disguise", "cavalier", "full helm",
				"tiara", "helmet", "Hat", "ears", "partyhat", "helm(t)",
				"helm(g)", "beret", "facemask", "sallet", "hat(g)", "hat(t)",
				"bandana", "Helm", "mitre", "crown", "cap", "visor" };
		String item = getItemName(itemId);
		if (item == null) {
			return false;
		}
	...
	public static boolean playerLegs(int itemId) {
		String[] data = { "tassets", "chaps", "bottoms", "bottom", "gown",
				"trousers", "platelegs", "robe", "robeskirt", "plateskirt",
				"legs", "leggings", "shorts", "Skirt", "skirt", "cuisse",
				"Trousers", "tasset" };
		String item = getItemName(itemId);
		if (item == null) {
			return false;
	...
	private static String[] fullbody = { "top", "chestplate", "shirt",
			...
			"chestplate", "Guthix body", "Saradomin body", "Zamorak body",
			"Armadyl body", "Bandos body", "Ancient body", "torso", "hauberk",
			"Dragon chainbody", "Corrupt dragon chainbody",
			"Morrigan's leather body", "poncho", "Pernix body" };

	private static String[] fullhat = { "med helm", "coif", "Dharok's helm",
			"hood", "Initiate helm", "Coif", "Helm of neitiznot", "mage hat",
	...
	private static String[] fullmask = { "full helm", "mask", "Verac's helm",
			...
			"Saradomin helm", "Slayer helmet", "visor", "cowl" };
